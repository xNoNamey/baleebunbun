...
function ApplyColors()
	local function ApplyHighlight(player)
		...
		local Existing = player.Character:FindFirstChild("H_0")
		if Existing then
			Existing:Destroy()
		end
		...
		Highlight.FillColor = Color3.new(0, 0.717647, 1)
	...
	SetupPlayer(player.LocalPlayer)
...
ApplyColors() -- enabled highlight body color
